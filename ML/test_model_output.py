...
temperature_range = np.arange(15, 80, 1)  # Temperature from 15°C to 30°C in steps of 1°C
...
for temp in temperature_range:
    for irrad in irradiance_range:
        ...
        input_data = [[temp, irrad, temp*irrad, solar_efficiency, teg_efficiency, net_efficiency]]
